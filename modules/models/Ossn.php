...
class ossn extends \yii\db\ActiveRecord
{
function ossn_user() {
		$user = new OssnUser;
		return $user;
...
function ossn_isLoggedin() {
		$user = $this->forceObject($_SESSION['OSSN_USER']);
...
// 	$this->ossn_register_callback('ossn', 'init', 'ossn_users');
// 	$this->ossn_add_hook('load:settings', 'language', 'ossn_site_user_lang_code');
// 	$this->ossn_add_hook('user', 'default:fields','ossn_user_fields_set_nonrequired', 201);
// }
}