...
class UserController extends \yii\web\Controller
{
    ...
    public function actionGetallposts()
    {
        ...
        $sql = "select * from tb_notifications where poster_guid=".$attributes['ownerid']." and type='share:post' ";
	...
	$subjects = array();
        ...
        $sql = "select * from tb_object where owner_guid in (".$userinfo.") or guid in (".implode(",", $subjects).") order by guid desc limit ".$attributes['minlimit']." , ".$attributes['maxlimit'];
